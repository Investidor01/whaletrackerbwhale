...
export const PAIRS = [
  ...
  "MATICUSDT", "DOTUSDT", "LINKUSDT", "LTCUSDT", "TRXUSDT", "SHIBUSDT", "ATOMUSDT", "ETCUSDT",
  "NEARUSDT", "APTUSDT", "ARBUSDT", "OPUSDT", "SUIUSDT", "TONUSDT", "PEPEUSDT", "INJUSDT",
  "FILUSDT", "AAVEUSDT", "SANDUSDT", "AXSUSDT", "UNIUSDT", "ICPUSDT", "RNDRUSDT", "FTMUSDT",
  "APEUSDT", "GRTUSDT", "ALGOUSDT", "HBARUSDT", "XLMUSDT", "VETUSDT", "MANAUSDT", "GALAUSDT",
];
